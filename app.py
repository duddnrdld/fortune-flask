...
def home():
    ...
    <body>
       ...
       <script>
           ...
           typeGreeting();
           // 배경에 flying image.png 생성 (6열 x 5행, delay 없이 시작)
           const numCols = 6;
           const numRows = 5;
           const animations = [
...
def result():
    ...
    <body>
       ...
       <script>
           ...
           typeGreeting();
           {script}
           // 배경 flying image.png 생성 (6열 x 5행, 즉시 시작)
           const numCols = 6;
           const numRows = 5;
           const animations = [
               "floatRotateBottomToTop",
